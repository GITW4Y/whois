...
<p style="text-align: center;"><b><label for="domain">Nome do Site ou endereço IP:</label></b> <input type="text" name="domain" id="domain" value="<?=$domain;?>"> <input type="submit" value="CONSULTAR"></p>
</form>
<?
if($domain) {
	$domain = trim($domain);
	...
	echo "<pre><span style=color:#ffffff;>\n" . $result . "\n</span></pre>";
}
?>
</body>
</html>
